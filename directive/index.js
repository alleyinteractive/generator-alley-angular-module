...
DirectiveGenerator.prototype.writeDirective = function writeDirective() {
  this.dest.mkdir('src');

  this.template('_directive.js', 'src/' + this.moduleNamePart + '.js');
  this.template('_directive.scss', 'src/' + this.moduleNamePart + '.scss');
}
